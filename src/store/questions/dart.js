const DartQuestions = {
    jun: [
        ...
        },
        {
            ...
            answerOption: 'a1',
            answer: 'При верном условии if, определяется указанное за ним значение.\n' +
                'Коллекция for() определяет указанное после неё значение\n' +
                'количеством её итераций',
            num: '#8',
        },
        {
            ...
            answer: 'late - модификатор, а не декларативный способ объявления переменной.\n' +
                'Если вы уверены, что переменная установлена до её использования,\n' +
        ...
        },
        {
            ...
            answerOption: 'a1',
            answer: 'Вы можете создать более одного итератора из одного и того же Iterable.\n' +
        ...
        },
        {
            ...
            option: {
                ...
                a4: 'Exception - тип в обработке ветки catch() прерывает дальнейшее выполнение',
            },
            answerOption: 'a4',
            answer: 'Первое предложение catch, соответствующее типу выброшенного объекта, обрабатывает исключение.\n' +
                'Если тип совпадает, исключение обрабатывается этим блоком, и дальнейшие блоки catch не выполняются.',
            num: '#20',
